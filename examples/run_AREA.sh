...
#SBATCH --output=/scratch/Users/allenma/eofiles/slurm_test.%j.out # Standard output
#SBATCH --error=/scratch/Users/allenma/eofiles/slurm_test.%j.err # Standard error log
...
#/Shares/down/public/INLCUDE_2024/kallisto_20241030/selfannoated/RNAvalues_normcounts.csv
#/Shares/down/public/INLCUDE_2024/kallisto_20241030/selfannoated/full_HP_binary_attribute.csv
commoncolumn=Participant
#rank_file=${indir}RNAvalues_normcounts.csv
rank_file=${indir}miniRNAvalues_normcounts.csv
